...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan Hijau Emerald Deep (#0F5257) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #0F5257}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#0F5257;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#0F5257;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#0F5257;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone emerald soft/mint-tinted (#F2F8F7) */
    '.info-box{background:#F2F8F7;border:1px solid #C4E3E1;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Hijau Emerald (#0F5257) */
    '.paket-box{background:#0F5257;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#F9FCFC;border:1px solid #DDF0EE;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft emerald/sage (#E5F3F2) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#E5F3F2;border:1px solid #ACD7D3;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#083A3E;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #C4E3E1;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
